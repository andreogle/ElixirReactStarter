defmodule WebTemplateWeb.UserSocket do
  @moduledoc """
  The persistent WebSocket every authenticated tab opens. Auth is by
  signed `Phoenix.Token` minted in `WebTemplateWeb.Plugs.SharedData`
  ...
  channel "global", WebTemplateWeb.GlobalChannel
  channel "user:*", WebTemplateWeb.UserChannel
  ...
  def connect(%{"token" => token}, socket, _connect_info) do
    case Phoenix.Token.verify(WebTemplateWeb.Endpoint, token_salt(), token, max_age: @max_age) do
