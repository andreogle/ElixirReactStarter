defmodule ElixirReactStarter.Timezones do
  @moduledoc """
  Single source of truth for the timezones offered on ElixirReactStarter.
  ...
  Returns the supported IANA timezone identifiers, sorted alphabetically.
      ...
      iex> "UTC" in ElixirReactStarter.Timezones.codes()
      true

      iex> "America/New_York" in ElixirReactStarter.Timezones.codes()
      true

      iex> "America/Cayman" in ElixirReactStarter.Timezones.codes()
      true

      iex> "Etc/GMT+5" in ElixirReactStarter.Timezones.codes()
      false
  ...
  Returns `true` when `tz` is one of the supported codes.
      ...
      iex> ElixirReactStarter.Timezones.valid?("Europe/London")
      true

      iex> ElixirReactStarter.Timezones.valid?("Mars/Olympus_Mons")
      false

      iex> ElixirReactStarter.Timezones.valid?(nil)
      false
  ...
  a twice-yearly basis if it matters.
      ...
      iex> ElixirReactStarter.Timezones.list() |> List.keyfind("UTC", 0)
      {"UTC", "UTC (UTC+0)"}

      iex> match?({"Asia/Kolkata", "Asia/Kolkata (UTC+5:30)"},
      ...>        List.keyfind(ElixirReactStarter.Timezones.list(), "Asia/Kolkata", 0))
      true
  ...
  observing it.
      ...
      iex> ElixirReactStarter.Timezones.offset_minutes("UTC")
      0

      iex> ElixirReactStarter.Timezones.offset_minutes("Asia/Kolkata")
      330

      iex> ElixirReactStarter.Timezones.offset_minutes("Mars/Olympus_Mons")
      nil
