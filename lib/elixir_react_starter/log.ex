defmodule ElixirReactStarter.Log do
  @moduledoc """
  ...
  Redacts an email address for safe logging.
      ...
      iex> ElixirReactStarter.Log.redact_email("jane@example.com")
      "j***@example.com"

      iex> ElixirReactStarter.Log.redact_email("a@b.co")
      "a***@b.co"

      iex> ElixirReactStarter.Log.redact_email(nil)
      "***"
