defmodule ElixirReactStarterWeb.FallbackController do
  @moduledoc """
  Default action result handler for controllers that declare
  `action_fallback ElixirReactStarterWeb.FallbackController`. Catches the
  ...
  def call(conn, {:error, :not_found}) do
    ...
    |> put_view(html: ElixirReactStarterWeb.ErrorHTML)
    |> render("404.html")
  end
